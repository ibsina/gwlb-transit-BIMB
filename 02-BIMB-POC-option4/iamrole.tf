...
# S3 Bucket license files for BYOL License
#
resource "aws_s3_object" "lic_ns1" {
  count  = var.bucket ? 1 : 0
...
resource "aws_s3_object" "lic_ns2" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.licenses[1]
...
resource "aws_s3_object" "lic_ew1" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.licenses[2]
  source = var.licenses[2]
  etag   = filemd5(var.licenses[2])
}

resource "aws_s3_object" "lic_ew2" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.licenses[3]
  source = var.licenses[3]
  etag   = filemd5(var.licenses[3])
}

# S3 Bucket config files
#
resource "aws_s3_object" "conf_ns1" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.bootstrap-fgtvm-ns1
  source = var.bootstrap-fgtvm-ns1
  etag   = filemd5(var.bootstrap-fgtvm-ns1)
}

resource "aws_s3_object" "conf_ns2" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.bootstrap-fgtvm-ns2
  source = var.bootstrap-fgtvm-ns2
  etag   = filemd5(var.bootstrap-fgtvm-ns2)
}

resource "aws_s3_object" "conf_ew1" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.bootstrap-fgtvm-ew1
  source = var.bootstrap-fgtvm-ew1
  etag   = filemd5(var.bootstrap-fgtvm-ew1)
}

resource "aws_s3_object" "conf_ew2" {
  count  = var.bucket ? 1 : 0
  bucket = aws_s3_bucket.s3_bucket[0].id
  key    = var.bootstrap-fgtvm-ew2
  source = var.bootstrap-fgtvm-ew2
  etag   = filemd5(var.bootstrap-fgtvm-ew2)
}
